/datum/language/greek
	name = "Greek"
	desc = "The language from the land of Marble."
	key = "g"
	flags = TONGUELESS_SPEECH
	space_chance = 40
	syllables = list("ΑΙ","ΑΝ","ΑΠ","ΑΣ","ΕΊ","ΕΙ","ΗΣ","ΙΑ","ΚΑ","ΝΑ","ΟΥ","ΠΟ","ΣΤ","ΤΑ","ΤΗ","ΤΟ","ΟΥ","ΑΙ","ΤΑ","ΚΑ","ΝΑ",
					"ΣΤ","ΣΕ","ΑΠΌ","ΚΑΙ","Δ","Γ","Φ","Ψ","ΤΟΥ","ΠΡΟ","ΜΈΝ","ΔΕΝ","ΤΗΣ","ΑΠΌ","ΡΑ","Ά","Έ","Ε","Ο","Ρ",
					"Τ","Ά","Κ","Ή", "Α","Σ","Σ","Ε","Ε","Έ","Ζ","Τ","Τ","ΙΚ","χ","Α","Α","Α", "π","δ","β","ΤΉΣ","ΘΑ"
					)
	icon_state = "greek" // Missing an icon for greek
	default_priority = 90
